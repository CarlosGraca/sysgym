...
class Payment extends Model
{
    ...
    protected $fillable = ['payment_id','note','payment_method','value_pay','status','value_pay','user_id','branch_id','client_id','free','discount','start_date','end_date','tenant_id','item_id','item_type','month_id','type'];
