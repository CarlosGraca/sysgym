	            ...
	            <div class="box-header with-border">
				  	<h3 class="box-title">
						<a href="<?php echo e(url('modalities')); ?>" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="<?php echo e(trans('adminlte_lang::message.back')); ?>">
					 	...
					 	<strong><?php echo e(trans('adminlte_lang::message.update_modality')); ?> </strong><span><?php echo e($modality->name); ?></span>
				  	</h3>
					...
					<div class="pull-right box-tools">
						...
						<a href="#" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="<?php echo e(trans('adminlte_lang::message.save')); ?>" id="update-modality">
