<div class="box-body slimscroll table-responsive no-padding">
    <table id="table-consult_agenda" class="table table-hover table-responsive">
        ...
        <?php $__currentLoopData = $consult_agenda; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <tr class="<?php echo e($table_name); ?>" data-key="<?php echo e($agenda->id); ?>" data-date="<?php echo e($agenda->date); ?>">
                <td class="col-md-6">

                    <div class="user-panel">
                        <div class="pull-left image">
                            <img  src="<?php echo e(url('/')); ?>/<?php echo e($agenda->patient_avatar); ?>" class="list_image" alt="Cinque Terre" style="max-height: 50px; max-width: 50px; min-height: 50px; min-width: 50px;">
                        </div>
                        <div class="pull-left info">
                            <p>
                                ...
                                <br>
                                <a href="#" style="color: rgba(0, 0, 0, 0.51); margin-top:5px;" ><i class="fa fa-at"></i> <?php echo e($agenda->email); ?></a>
                            </p>
                            <!-- Status -->
                        </div>
                    </div>
                ...
                <td class="col-md-3">
                    <div class="user-panel">
                        <div class="text-center">
                            <p>
                                <a class="users-list-name" href="#" data-toggle="tooltip"  data-placement="bottom" title="<?php echo e(\Carbon\Carbon::parse($agenda->date)->diffForHumans()); ?>" ><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d', $agenda->date)->format('d/m/Y')); ?> <?php if($type == 'scheduled'): ?> | <?php echo e($agenda->starttime); ?> - <?php echo e($agenda->endtime); ?> <?php endif; ?></a>
                        ...
                        <div class="pull-right text-center">
                            <div class="btn-group">
                                ...
                                <?php if($type == 'scheduled'): ?>
                                    ...
                                    <a href="#!edit" data-url="<?php echo e(route('consult_agenda.edit',$agenda->id)); ?>" data-placement="left" class="show-agenda-modal" data-toggle="tooltip" title="<?php echo e(trans('adminlte_lang::message.edit')); ?>" data-title="<?php echo e(trans('adminlte_lang::message.update_consult_agenda')); ?>">
                                ...
                                <?php else: ?>
                                    <a href="#!re-agenda" data-toggle="tooltip" data-placement="left"  data-key="<?php echo e($agenda->id); ?>" data-date="<?php echo e($agenda->date); ?>" id="agenda_re_agenda" title="<?php echo e(trans('adminlte_lang::message.re_agenda')); ?>">
