...
<script src="<?php echo e(asset('/plugins/datatables/extensions/responsive/js/dataTables.responsive.min.js')); ?>" type="text/javascript"></script>
...
<script type="text/javascript">
  /*var localName = '<?php echo e(count($system) > 0 ? $system->lang : config('app.locale')); ?>';*/
