					    ...
					    <ul class="nav nav-tabs">
					     ...
					     <div class="tab-content">
					        		...
					        		<div class="col-lg-12">
					        			<ul class="list-group list-group-unbordered">
						                    <li class="list-group-item">
						                      <b><?php echo e(trans('adminlte_lang::message.name')); ?>: </b><span class="user-name"><?php echo e(Auth::user()->name); ?></span> <a href="#" id='user-name' title='Edit'> <i class="fa fa-pencil"></i> </a>
						                    </li>
						                    <li class="list-group-item">
						                      <b><?php echo e(trans('adminlte_lang::message.email')); ?>: </b><?php echo e(\Auth::user()->email); ?>
						                    ...
						                    <li class="list-group-item">
						                      <b><?php echo e(trans('adminlte_lang::message.create_date')); ?>: </b> <?php echo e(\Carbon\Carbon::parse(\Auth::user()->created_at)->format('d/m/Y')); ?>
					        ...
					        <div class="tab-pane " id="password">
					            <form action="<?php echo e(url('auth/password/reset')); ?>" method="post" class="form-horizontal">
