	...
	<div class="row">
	    <div class="col-lg-12">
	        <div class="box box-default">
	            ...
	            <div class="box-body">
					<?php echo Form::open(['route'=>'consult_type.store', 'id'=>'consult_type-form','files'=>true]); ?>

	                 	<?php echo $__env->make('consult_type.form', ['type'=>'create'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<?php echo Form::close(); ?>
