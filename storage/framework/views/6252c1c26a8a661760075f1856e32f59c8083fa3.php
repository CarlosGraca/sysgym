	            ...
	            <div class="box-header with-border">
	              ...
	              <div class="pull-right box-tools">
					...
					<div class="pull-right box-tools">
						...
						<a href="<?php echo e(url('patients')); ?>" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="<?php echo e(trans('adminlte_lang::message.show_details')); ?>" id="patient_detail" style="display: none;">
