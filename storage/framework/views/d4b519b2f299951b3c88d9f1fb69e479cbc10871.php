                ...
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        <a href="<?php echo e(url('branches')); ?>" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="<?php echo e(trans('adminlte_lang::message.list')); ?>">
                            <i class="fa fa-list"></i> <?php echo e(trans('adminlte_lang::message.branch_list')); ?>
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#personal_data" data-toggle="tab"><i class="fa fa-id-card-o"></i> <?php echo e(trans('adminlte_lang::message.personal_data')); ?></a></li>
                                <li><a href="#officeHours" data-toggle="tab"><i class="fa fa-clock-o"></i> <?php echo e(trans('adminlte_lang::message.office_hours')); ?></a></li>
                                ...
                                <div class="active tab-pane" id="personal_data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <ul class="list-group list-group-unbordered">
                                                <li class="list-group-item">
                                                    <i class="fa fa-building-o"></i>  <b><?php echo e(trans('adminlte_lang::message.name')); ?>: </b>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <ul class="list-group list-group-unbordered">
                                                <li class="list-group-item">
                                                    <i class="fa fa-user"></i>  <b><?php echo e(trans('adminlte_lang::message.manager')); ?>: </b>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <ul class="list-group list-group-unbordered">
                                                <li class="list-group-item">
                                                    ...
                                                    <a> <?php echo e($branch->address); ?>, <?php echo e($branch->city); ?> </a>
                                                </li>
                                                <li class="list-group-item">
                                                    <i class="fa fa-envelope"></i>  <b><?php echo e(trans('adminlte_lang::message.email')); ?>: </b>
