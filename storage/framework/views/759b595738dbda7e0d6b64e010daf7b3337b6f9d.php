        ...
        <span class="logo-mini">
            <div class="user-panel">
                <div class="pull-left image">
                    <img  src="<?php echo e(url('/img/clinic/doctor_icon.png')); ?>" class="img-circle" alt="Cinque Terre"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="user user-menu">
                  <a href="<?php echo e(url('auth/profile')); ?>" data-toggle="tooltip" title="<?php echo e(trans('adminlte_lang::message.profile')); ?>">
                    ...
                    <!-- hidden-xs hides the username on small devices so only the image appears. -->
                    <span class="hidden-xs"><span class="name"><?php echo e(Auth::user()->name); ?></span></span>
                  </a>
                </li>
                <li>
