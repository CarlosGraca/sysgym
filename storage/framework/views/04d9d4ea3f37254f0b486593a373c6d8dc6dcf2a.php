<div class="row">
    ...
    <?php echo Form::hidden('flag', $flag, ['class'=>'form-control','id'=>'flag']); ?>
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <table id="table-office_hours" class="table table-bordered table-striped">
                    ...
                    <thead>
                    <th class="col-md-5"><?php echo e(trans('adminlte_lang::message.week_day')); ?></th>
                    <th class="col-md-3 text-center"><?php echo e(trans('adminlte_lang::message.start_time')); ?></th>
                    <th class="col-md-3 text-center"><?php echo e(trans('adminlte_lang::message.end_time')); ?></th>
                    ...
                    <?php if(isset($schedules)): ?>
                        <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <tr class="office_hours_table" data-key="<?php echo e($schedule->id); ?>"  data-week="<?php echo e($schedule->week_day); ?>">
                                ...
                                <td class="start_time text-center" ><?php echo e($schedule->start_time); ?></td>
                                <td class="end_time text-center" ><?php echo e($schedule->end_time); ?></td>
