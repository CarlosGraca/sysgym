                    ...
                    <div id="setup_wizard" class="form-wizard form-wizard-horizontal">
                            ...
                            <div class="tab-content clearfix">
                                <div class="tab-pane active" id="step1">
                                    <div class="col-lg-12">
                                    <br/><br/>
                                        <?php echo Form::open(['route'=>'company.store', 'id'=>'company-form','files'=>true,'class'=>'form-validation-1']); ?>

                                            <?php echo $__env->make('company.form', ['submitButtonText'=>'Save','type'=>'create','form'=>'setup'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <?php echo Form::close(); ?>
                                ...
                                <div class="tab-pane" id="step2">
                                    <div class="col-lg-12">
                                        <br/><br/>
                                        <?php echo Form::open(['route'=>'users.store', 'id'=>'user-form','files'=>true,'class'=>'form-validation-2']); ?>

                                            <?php echo $__env->make('users.form', ['type'=>'create'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <?php echo Form::close(); ?>
                                ...
                                <div class="tab-pane" id="step3">
                                    <div class="col-lg-12">
                                        <br/><br/>
                                        <?php echo Form::model($system, ['method'=>'PATCH','route'=>['system.update', $system->id],'id'=>'system-form','files'=>true,'class'=>'form-validation-3']); ?>

                                            <?php echo $__env->make('system.form', ['submitButtonText'=>'save','type'=>'update','form'=>'setup'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <?php echo Form::close(); ?>
