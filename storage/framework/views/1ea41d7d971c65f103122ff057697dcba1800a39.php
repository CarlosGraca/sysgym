		...
		<?php if($type == 'update'): ?>
			...
			<div class="row">
				...
				<hr class="h-divider">
					...
					<?php $__currentLoopData = $user->tenant->branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
