<?php $__env->startSection('htmlheader_title'); ?>
	<?php echo e(trans('adminlte_lang::message.new_procedure_group')); ?>
	...
	<div class="row">
	    <div class="col-lg-12">
	        <div class="box box-default">
	            ...
	            <div class="box-body">
					<?php echo Form::open(['route'=>'procedure_group.store', 'id'=>'procedure_group-form','files'=>true]); ?>

	                 	<?php echo $__env->make('procedure_group.form', ['type'=>'create'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<?php echo Form::close(); ?>
