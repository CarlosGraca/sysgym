                        ...
                        <td style="<?php echo e($style['email-masthead']); ?>">
                            <?php if(isset($system)): ?>
                                <a style="<?php echo e($fontFamily); ?> <?php echo e($style['email-masthead_name']); ?>" href="<?php echo e(url('/')); ?>" target="_blank">
                                    <!--
                                    <image src="<?php echo e(asset('img/logo.png')); ?>" height="50" />
                                    -->
                            ...
                            <?php else: ?>
                                <a style="<?php echo e($fontFamily); ?> <?php echo e($style['email-masthead_name']); ?>" href="<?php echo e(url('/')); ?>" target="_blank">
                                <!--
                                    <image src="<?php echo e(asset($company->logo)); ?>" height="50" />
                                    -->
                                    ...
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                        ...
                                        <?php if(isset($license_key)): ?>
                                            <div style="color: #31708f; background-color: #d9edf7; border-color: #bce8f1;
                                                        ...
                                                        border-radius: 4px;
                                                        text-align: center;">
                                                <strong>License To:  </strong> <?php echo e($name); ?><br>
                                                <strong>Product key: </strong> <?php echo e($license_key); ?>
                                        ...
                                        <?php if(isset($reset_password)): ?>
                                            <div style="color: #31708f; background-color: #d9edf7; border-color: #bce8f1;
                                                ...
                                                <strong>Password: </strong> <?php echo e($reset_password); ?>
