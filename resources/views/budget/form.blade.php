<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		{!! Form::hidden('budget_id', ($type == 'update' ? $budget_type->id : null), ['class'=>'form-control','id'=>'budget_type_id']) !!}
		{!! Form::hidden('patient_id','', ['class'=>'form-control','id'=>'patient_id']) !!}
		{!! Form::hidden('user_id', Auth::user()->id, ['class'=>'form-control','id'=>'user_id']) !!}
		<div class="row">
			<span ><strong class="title">{{ trans('adminlte_lang::message.patient_information') }}</strong></span>
			<hr class="h-divider" >
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="form-group form-group-sm">
					...
					{!! Form::text('patient', ($type == 'update' ? $budget_type->patient : null) , ['class'=>'form-control','onfocus'=>'onfocus','placeholder'=>trans('adminlte_lang::message.type_patient_name')]) !!}
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="form-group form-group-sm">
					...
					{!! Form::email('email', ($type == 'update' ? $patient->email : null) , ['class'=>'form-control','readonly'=>'readonly']) !!}
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="form-group form-group-sm">
					...
					{!! Form::text('mobile', ($type == 'update' ? $patient->mobile : null) , ['class'=>'form-control','readonly'=>'readonly']) !!}
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="form-group form-group-sm">
					...
					{!! Form::text('phone', ($type == 'update' ? $patient->phone : null) , ['class'=>'form-control','readonly'=>'readonly']) !!}
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="form-group form-group-sm">
					...
					{!! Form::select('has_secure',[0 =>trans('adminlte_lang::message.not'), 1 =>trans('adminlte_lang::message.yes') ], ($type == 'update' ? $patient->has_secure : null) , ['class'=>'form-control','id'=>'has_secure','disabled'=>'disabled']) !!}
				</div>
			</div>
