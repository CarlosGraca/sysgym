    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
            <?php $branch = \App\Branch::where('id',\Auth::user()->branch_id)->first(); ?>
                ...
                {!! Form::hidden('client_id', ($type == 'update' ? $payment->client_id : null), ['class'=>'form-control','id'=>'client_id']) !!}
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="form-group form-group-sm">
                    ...
                    {!! Form::text('client', ($type == 'update' ? $payment->client->name : null) , ['class'=>'form-control','onfocus'=>'onfocus']) !!}
                </div>
            </div>
