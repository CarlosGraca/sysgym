                                ...
                                @if(isset($payments))
                                    @foreach($payments as $payment)
                                        <tr class="payment-modality" data-key="{{ $payment->idpayment }}">
                                            <td style="display: none;" data-value="{{ $payment->idmatricula }}"  class="payment-id-matricula"></td>
                                            <td><input type="checkbox" class="check-payment" value="{{ $payment->idmatricula }}" />&nbsp;</td>
                                            <td>{{ $payment->name }}</td>
