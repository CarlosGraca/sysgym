...
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.campaign_message') }}
@endsection
	        ...
	        <div class="box box-default">
	            <div class="box-header with-border">
	              ...
	              <div class="pull-left box-tools">
	                  <a href="{{ url('campaign_messages/create') }}" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="{{ trans('adminlte_lang::message.new_campaign_message') }}">
	                       <i class="fa fa-plus"></i> {{ trans('adminlte_lang::message.new_campaign_message') }}
	                  </a>
