		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-10 col-xs-10">
				<div class="form-group form-group-sm">
					...
					{!! Form::select('week_day', $weeks, ($type == 'update' ? $branch->island_id : null) , ['class'=>'form-control','id'=>'branch_week','placeholder'=>' (SELECT CONSULT TYPE) ']) !!}
				</div>
			</div>
						...
						<table id="table-office_hours" class="table table-bordered table-striped">
                            ...
                            @if(isset($schedules))
                                @foreach($schedules as $schedule)
                                    <tr class="office_hours_table" data-key="{{ $schedule->id }}">
