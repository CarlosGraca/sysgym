                        ...
                        <td style="{{ $style['email-masthead'] }}">
                            @if(isset($system))
                                <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                                    <!--
                                    <image src="{{ asset('img/logo.png') }}" height="50" />
                                    -->
                                    {{  config('app.name') }}
                                </a>
                            @else
                                <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                                <!--
                                    <image src="{{ asset($company->logo) }}" height="50" />
                                    -->
                                    {{ $company->name }}
                                </a>
                            @endif
                                    ...
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        @if(isset($license_key))
                                            <div style="color: #31708f; background-color: #d9edf7; border-color: #bce8f1;
                                                        ...
                                                        border-radius: 4px;
                                                        text-align: center;">
                                                <strong>License To:  </strong> {{ $name }}<br>
                                                <strong>Product key: </strong> {{ $license_key }}
                                            </div>
                                        @endif
                                        ...
                                        @if(isset($reset_password))
                                            <div style="color: #31708f; background-color: #d9edf7; border-color: #bce8f1;
                                                ...
                                                <strong>Password: </strong> {{ $reset_password }}
                                            </div>
                                        @endif
