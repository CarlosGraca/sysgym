...
class MenuTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Menu::create(['parent_id'=>0,'title'=>'Gestão de Cobrança','url'=>'payments','menu_order'=>'4','status'=>'1','level'=>null,'icon'=>'fa fa-money','description'=>null]);
		...
		Menu::create(['id'=>19,'parent_id'=>11,'title'=>'Gestão de Dominios','url'=>'domains','menu_order'=>'5','status'=>'1','level'=>null,'icon'=>null,'description'=>null]);
		...
		Menu::create(['id'=>21,'parent_id'=>11,'title'=>'Empresa','url'=>'company','menu_order'=>0,'status'=>'1','level'=>null,'icon'=>null,'description'=>null]);
